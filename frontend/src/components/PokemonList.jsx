...
function PokemonList({ pokemons, loading, error, loadMore, offset, onSelect, selectedId }) {
    ...
    return (
        <div className="pokemon-list">
            {pokemons.map((pokemon) => (
                <PokemonCard key={pokemon.id} pokemon={pokemon} onSelect={onSelect} selectedId={selectedId} />
            ))}
